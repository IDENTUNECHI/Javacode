package OldRepository.java1.Practice.w11;
...
public class Dice {
    public static void main(String[] args) {
        ...
        for(int i=num_dice; i<=6*num_dice; i++){
            System.out.println(i+"횟수:   "+ castDice(num_dice, i, generator));
        }
    ...
    public static int castDice(int num_dice, int n ,Random generator){
